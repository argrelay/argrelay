            ...
            (
                ...
                None,
                {
                    0: {
                        ...
                        f"{func_envelope_path_step_prop_name(1)}": AssignedValue("intercept", ValueSource.init_value),
                    },
                    1: {
                        ...
                        output_format_prop_name: AssignedValue(OutputFormat.json_format.name, ValueSource.default_value),
                    },
                    2: {
                        f"{func_envelope_path_step_prop_name(0)}": AssignedValue("some_command", ValueSource.init_value),
                        f"{func_envelope_path_step_prop_name(1)}": AssignedValue("goto", ValueSource.explicit_offered_arg),
                        f"{func_envelope_path_step_prop_name(2)}": AssignedValue("service", ValueSource.explicit_offered_arg),
                    },
                    3: {
            ...
            (
                ...
                None,
                {
                    ...
                    1: {
                        ...
                        output_format_prop_name: AssignedValue(OutputFormat.repr_format.name, ValueSource.explicit_offered_arg),
                    },
                    2: {
                        f"{func_envelope_path_step_prop_name(0)}": AssignedValue("some_command", ValueSource.init_value),
                        f"{func_envelope_path_step_prop_name(1)}": AssignedValue("goto", ValueSource.explicit_offered_arg),
            ...
            (
                ...
                ],
                {
                    0: {
                        ...
                        f"{func_envelope_path_step_prop_name(0)}": AssignedValue("some_command", ValueSource.init_value),
                        f"{func_envelope_path_step_prop_name(1)}": AssignedValue("intercept", ValueSource.explicit_offered_arg),
