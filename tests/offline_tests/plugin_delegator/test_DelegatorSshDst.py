            ...
            (
                ...
                [],
                {
                    0: {
                        ...
                        f"{func_envelope_path_step_prop_name(0)}": AssignedValue("ar_ssh", ValueSource.init_value),
                        f"{func_envelope_path_step_prop_name(1)}": AssignedValue(SpecialChar.NoPropValue.value, ValueSource.implicit_value),
                        f"{func_envelope_path_step_prop_name(2)}": AssignedValue(SpecialChar.NoPropValue.value, ValueSource.implicit_value),
                        f"{func_envelope_path_step_prop_name(3)}": AssignedValue(SpecialChar.NoPropValue.value, ValueSource.implicit_value),
                        f"{ReservedPropName.func_state.name}": AssignedValue(FuncState.fs_demo.name, ValueSource.implicit_value),
                        f"{ReservedPropName.func_id.name}": AssignedValue(func_id_ssh_dst_, ValueSource.implicit_value),
                    },
                    1: {
            ...
            (
                ...
                [],
                {
                    0: {
                        ...
                        f"{func_envelope_path_step_prop_name(1)}": AssignedValue("ssh", ValueSource.explicit_offered_arg),
                        f"{func_envelope_path_step_prop_name(2)}": AssignedValue(SpecialChar.NoPropValue.value, ValueSource.implicit_value),
                        f"{func_envelope_path_step_prop_name(3)}": AssignedValue(SpecialChar.NoPropValue.value, ValueSource.implicit_value),
                        f"{ReservedPropName.func_state.name}": AssignedValue(FuncState.fs_demo.name, ValueSource.implicit_value),
                        f"{ReservedPropName.func_id.name}": AssignedValue(func_id_ssh_dst_, ValueSource.implicit_value),
                    ...
                    1: {
                        ...
                        ServicePropName.dir_path.name: AssignedValue(SpecialChar.NoPropValue.value, ValueSource.implicit_value),
                    },
                    2: None,
                },
                DelegatorSshDst,
