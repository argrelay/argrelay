            ...
            (
                ...
                ],
                {
                    0: {
                        ...
                        f"{func_envelope_path_step_prop_name(1)}": AssignedValue("list", ValueSource.explicit_offered_arg),
        ...
        test_cases = [
            (
                ...
                1,
                {
                    ...
                    ServicePropName.cluster_name.name: AssignedValue("dev-emea-downstream", ValueSource.explicit_offered_arg),
                },
