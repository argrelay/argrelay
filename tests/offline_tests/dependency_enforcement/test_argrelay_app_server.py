...
class ThisTestClass(ImportLinterTestClass):
    ...
    def test_relationship(self):
        assert_test_module_name_embeds_prod_module_name(argrelay_app_server)
        ...
        self.assert_import_linter_success(
            ...
            .add_forbidden_module_spec(
                [
                    ...
                    f"{argrelay_schema_config_check_env.__name__}",
                    f"{argrelay_schema_config_client.__name__}",
