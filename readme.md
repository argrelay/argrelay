...
A framework to select **custom data** input for command line interface (CLI) tools.
...
*   When your data (luckily) has simple relationship and instantly queryable, use [`argcomplete`][argcomplete_github].
...
| GUI                                                                           | CLI                                                       |
|-------------------------------------------------------------------------------|-----------------------------------------------------------|
| :heavy_plus_sign: diagrams, images, video                                     | :heavy_multiplication_x: out of scope for (dev) apps      |
