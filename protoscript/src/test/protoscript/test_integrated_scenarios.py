...
class ThisTestClass(PyfakefsTestCase):
    ...
    def test_bootstrap_proceeds_on_missing_conf_proj_file_fails_on_missing_target_dst_dir_path(
        self,
    ...
    def test_bootstrap_proceeds_on_existing_conf_proj_file_fails_on_missing_target_dst_dir_path(
        self,
        mock_state_script_dir_path,
    ):
        # given:
