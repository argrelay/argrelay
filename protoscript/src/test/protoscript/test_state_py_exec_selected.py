...
from protoscript.proto_code import (
    Bootstrapper_state_env_conf_man_file_data,
    Bootstrapper_state_env_conf_man_file_path,
    Bootstrapper_state_proj_dir_path_specified,
...
class ThisTestClass(PyfakefsTestCase):
    ...
    @patch(
        f"{proto_code.__name__}.{Bootstrapper_state_proj_dir_path_specified.__name__}._bootstrap_once"
    )
    @patch(
        f"{proto_code.__name__}.{Bootstrapper_state_env_conf_man_file_data.__name__}._bootstrap_once"
    )
    @patch(
    ...
    def test_success_on_path_to_curr_python_is_outside_of_path_to_venv_when_venv_is_created(
        ...
        mock_state_env_conf_man_file_data,
        mock_state_proj_dir_path_specified,
        ...
        mock_state_proj_dir_path_specified.return_value = mock_proj_dir
        mock_state_env_conf_man_file_data.return_value = {
    ...
    @patch(
        f"{proto_code.__name__}.{Bootstrapper_state_env_conf_man_file_path.__name__}._bootstrap_once"
    )
    @patch(
        f"{proto_code.__name__}.{Bootstrapper_state_proj_dir_path_specified.__name__}._bootstrap_once"
    )
    ...
    def test_failure_when_path_to_python_is_inside_venv(
        ...
        mock_state_env_conf_man_file_data,
        mock_state_proj_dir_path_specified,
        mock_state_env_conf_man_file_path,
        mock_state_py_exec_specified,
        mock_state_script_dir_path,
        mock_state_target_dst_dir_path,
    ):
        ...
        mock_state_env_conf_man_file_path.return_value = (
            "fake: " + EnvState.state_env_conf_man_file_path.name
        )
