...
# The "distribution root" refers to the top-level directory where the project code resides.
...
version_file = f"{distrib_root}/main/protoscript/proto_code.py"
...
# pip install --editable "${project_dir}/"[test]
extras_require = {
    "test": tests_require,
}
