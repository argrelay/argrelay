    ...
    def adjust_before_validation(
        ...
        **kwargs,
        ...
        if check_env_plugin_instances_ not in input_dict:
            input_dict[check_env_plugin_instances_] = input_dict.pop(
    ...
    def make_object(
        ...
        **kwargs,
        ...
        for plugin_instance_id in input_dict[check_env_plugin_instances_]:
            plugin_entry: PluginEntry = input_dict[check_env_plugin_instances_][
                plugin_instance_id
            ]
            check_env_plugin_instance_id_activate_order_dag[plugin_instance_id] = (
