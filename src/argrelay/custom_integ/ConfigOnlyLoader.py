...
class ConfigOnlyLoader(AbstractLoader):
    ...
    def update_static_data(
        ...
        # *   list of `class_name`-s user wants:
        class_names = self.plugin_config_dict[class_names_]
        # *   list of `index_field`-s user wants:
        index_fields = self.plugin_config_dict[index_fields_]
        ...
        init_envelop_collections(
            self.server_config,
            class_names,
            lambda _collection_name, _class_name: index_fields,
        )
        ...
        for class_name in class_names:
            ...
            # Keep removing list items after inserting them into specific collections based on class:
