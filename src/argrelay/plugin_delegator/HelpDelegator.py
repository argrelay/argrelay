...
class HelpDelegator(InterceptDelegator):
        ...
        if interp_ctx.curr_container_ipos >= subsequent_function_container_ipos_:
            ...
            invocation_input = InvocationInput(
                ...
                data_envelopes = (
                    ...
                    get_data_envelopes(interp_ctx)[:subsequent_function_container_ipos_]
                    +
    ...
    def invoke_action(invocation_input: InvocationInput):
        ...
        if invocation_input.data_envelopes[function_container_ipos_][envelope_id_] == SpecialFunc.help_func.name:
            for data_envelope in invocation_input.data_envelopes[subsequent_function_container_ipos_:]:
