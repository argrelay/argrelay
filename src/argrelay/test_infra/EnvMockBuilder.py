...
class EnvMockBuilder:
    ...
    *   ...
    ...
    # Implement FS_63_63_14_08 generated config for `out`-processes to read it (see FS_66_17_43_42 test infra):
    ...
    def assert_config_substitution_mutually_exclusive(self):
        ...
        ), "FS_63_63_14_08: generated config: mocked config and generated config are mutually exclusive"
    ...
    def assert_client_config_substitute_enabled(self):
        assert (
            ...
            or
            self.generate_client_config_file
        ), "FS_63_63_14_08: generated config: when enabled: either mocked config or generated config"
