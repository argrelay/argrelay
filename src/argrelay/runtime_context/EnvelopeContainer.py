...
class EnvelopeContainer:
    ...
    *   `ServerAction.DescribeLineArgs` (Alt+Shift+Q)
    ...
    #       Rename to `assigned_prop_name_to_prop_value`.
    ...
    # TODO: TODO_66_66_75_78: Split `arg` to `prop` concepts:
    #       Rename:
    #       `remaining_types_to_values` -> `remaining_prop_name_to_prop_value`.
    # TODO: TODO_55_51_89_92: review and update `args_context`
    ...
    this `prop_name` moves to `assigned_types_to_values`.
    """

    # TODO: TODO_66_66_75_78: Split `arg` to `prop` concepts:
    #       Rename:
    #       `filled_types_to_values_hidden_by_defaults` -> `filled_prop_values_hidden_by_defaults`.
    ...
    `assigned_types_to_values` are listed here.
    """
    ...
    def populate_implicit_arg_values(
        ...
        *   False otherwise.
        ...
        for arg_type in self.search_control.arg_name_to_prop_name_dict.values():
