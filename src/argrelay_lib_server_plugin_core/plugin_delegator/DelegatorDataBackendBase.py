...
from argrelay_app_server.relay_server.IndexModel import index_props_
...
def get_collection_search_control() -> dict:
    ...
    def run_search_control(
        ...
        if func_param_container_offset < len(search_control_list):
            ...
            collection_name_container.data_envelopes = (
                interp_ctx.query_engine.query_data_envelopes_for(
            ...
            if len(collection_name_container.data_envelopes) != 1:
                ...
                index_props: list[str] = collection_name_container.data_envelopes[0][
                    envelope_payload_
                ][index_props_]
                collection_name = collection_name_container.data_envelopes[0][
